function plot_confusion_tripanel_fx17_autodetect()
% Tripanel of confusion matrices – FX17 (NIR–SWIR)
...
%
% Outputs:
%   FX17_confusion_matrices_tripanel.png (600 dpi)
%   FX17_confusion_matrices_tripanel.pdf (vector)
%
% ------------------ Inputs ------------------
files = { ...
...
out_png = 'FX17_confusion_matrices_tripanel.png';
out_pdf = 'FX17_confusion_matrices_tripanel.pdf';
...
for i = 1:3
    ...
    try
        ...
        if ismember('Model', SM.Properties.VariableNames) && ismember('Mean_BalAcc', SM.Properties.VariableNames)
            ...
            hasCand = any(strcmpi(sheets, cand));
            if hasCand
...
for i = 1:3
    ...
    % Ticks and labels according to data
    n = size(M,1);
    xticks(1:n); yticks(1:n);
    % if there are valid labels, use them; otherwise 1..n

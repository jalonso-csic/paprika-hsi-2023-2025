%% ------------------------------------------------------------------------
% File: fx17_supervised_hsi_nestedcv_refactor_v2.m
% Title: SUPERVISED HYPERSPECTRAL ANALYSIS (FX17) — Refactored Version v2
%
% PURPOSE:
%   - Supervised HSI analysis for FX17 using repeated nested cross-validation.
%   - Models: PLS-DA (with/without VIP), SVM (linear/RBF, VIP), optional PCA+SVM baseline.
%
% DESCRIPTION:
%   - Adapted for the FX17 camera (900–1700 nm).
...
%
% AUTHOR: J. Alonso (refactor from the original script)
% DATE: 16-Aug-2025
...
% --- Outputs ---
cfg.output_folder = fullfile(pwd, 'FX17_Results');  % save under current MATLAB folder
